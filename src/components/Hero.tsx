...
function Hero({ movieData }: Props) {
  const imagenSrc =
    "https://image.tmdb.org/t/p/original/" + movieData?.backdrop_path || heroImg
  ...
  return (
    <div className="relative w-full overflow-hidden pb-4 pt-20 font-Montserrat text-slate-100">
      ...
      <div className="mx-10 pt-12 lg:w-3/5 xl:w-2/5">
      ...
      <div className="-mt-12 mb-12 mr-10 flex h-full flex-col items-end font-semibold lg:text-xl">
